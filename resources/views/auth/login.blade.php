        ...
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Felix L. Huerte Jr
              <div class="mt-2">
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                ...
                <h5 class="font-weight-normal text-muted-transparent">Brgy. Sto.Tomas, Calauan Laguna</h5>
              </div>
              {{-- System by: <a class="text-light bb" target="_blank" href="https://unsplash.com/photos/a8lTjWJJgLA">Felix L. Huerte Jr.</a> on <a class="text-light bb" target="_blank" href="https://unsplash.com">Unsplash</a> --}}
