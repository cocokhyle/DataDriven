                ...
                <div class="page" style="width: 8.3in;" id="element-to-print">
                    <div class="wrapper">
                        <div class="header">  
                            ...
                            <p>   MUNICIPALITY CALAUAN </p>
                            <p> BARANGAY STO.TOMAS  </p>
                        ...
                        <div class="body">
                            <div class="officials" style="width: 2.75in; border-left: 2px solid black;">
                                <div class="official-wrapper">
                                        ...
                                        alt="brgy-bayog-logo" >
                                    <p style = "margin-bottom: 20px;"> <strong> Barangay Sto.Tomas </strong></p>
                                    ...
                                    <div class="text-part">
                                        ...
                                        <p id="content">
                                            This is to certify that <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }} {{ $resident->suffix_name }}</strong> of legal age and bonafide resident of <strong>Purok-{{ $resident->purok}} {{ $resident->street}}, Barangay Sto.Tomas, Calauan, Laguna.</strong>  has not been charged of any misconduct in violation of Barangay rules and policies. Neither had I received any information that he/she has no pending case in court. He/she is observed to be of <strong>Good Moral Character</strong> .
