                                ...
                                <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="text-part">
                                            ...
                                            <strong>{{ \Carbon\Carbon::parse($resident->birthday)->format('F d, Y') }} </strong> sa <strong> {{$resident->birthplace}} </strong> at kasalukuyang nakatira sa ___________ Brgy.Sto.Tomas, Calauan
