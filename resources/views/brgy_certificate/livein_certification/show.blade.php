                        ...
                        <div class="body">
                            <div class="officials" style="width: 2.75in; border-left: 2px solid black;">
                                <div class="official-wrapper">
                                        ...
                                        alt="brgy-bayog-logo" >
                                    <p style = "margin-bottom: 20px;"> <strong> Barangay S</strong></p>
                                    ...
                                    <div class="text-part">
                                        ...
                                        <p id="content">
                                            Ito ay pagpapatunay na sila <strong>{{ $resident->first_name }} {{ $resident->middle_name }}
                                                {{ $resident->last_name }} {{ $resident->suffix_name }} at {{ $partner }}</strong> nasa hustong taong gulang, residente ng <strong>Purok-{{ $resident->purok}} {{ $resident->street}}, Barangay Sto.Tomas, Calauan, Laguna</strong> ay nagsasama bilang mag asawa.
