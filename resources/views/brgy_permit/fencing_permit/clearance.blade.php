                            ...
                            <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                <div class="content-wrapper">
                                    ...
                                    <div class="text-part" style = "margin-top:100px;">
                                        ...
                                        <p id="content">
                                            Ito ay pagpapatunay na si <strong> {{ $fencing->name}} </strong> may sapat na gulang at kasalukuyang naninirahan sa <strong>{{ $fencing->address}}.</strong> At ang kanyang lupain ay nasa Barangay Sto.Tomas, Calauan, Laguna.
